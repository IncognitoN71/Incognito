                    ...
                    nodes = {
                        {
                            ...
                            nodes = {
                                { n = G.UIT.T, config = { text = ' ' .. localize { type = 'variable', key = (compatible and 'nic_mesmerizer_active' or 'nic_mesmerizer_inactive') } .. ' ', colour = G.C.UI.TEXT_LIGHT, scale = 0.32 * 0.8 } },
                            }
                        }
                    }
                }
                    ...
                    nodes = {
                        {
                            ...
                            config = { ref_table = card, align = "m", colour = compatible and mix_colours(G.C.GREEN, G.C.JOKER_GREY, 0.8) or mix_colours(G.C.RED, G.C.JOKER_GREY, 0.8), r = 0.05, padding = 0.06 },
                            nodes = {
                                { n = G.UIT.T, config = { text = ' ' .. localize { type = 'variable', key = (compatible and 'nic_territory_active' or 'nic_territory_inactive') } .. ' ', colour = G.C.UI.TEXT_LIGHT, scale = 0.32 * 0.8 } },
                            }
                        }
                    }
                }
