...
Incognito.teto_table = {
    { joker = "j_nic_kasane_jokto", language = "en", type = "inspired", name = "NeatoJokers", link = "https://github.com/neatoqueen/NeatoJokers" },
    { joker = "j_nic_ambassador_teto", language = "jp", type = "song", name = "アンバサダー", artist = "dada", link = "https://www.youtube.com/watch?v=uRjI2ve5v2A" },
    ...
    { joker = "j_nic_doctor_kidori", language = "jp", type = "song", name = "イガク", artist = "原口沙輔", link = "https://www.youtube.com/watch?v=F38EuG2dAyM" },
    { joker = "j_nic_birdbrain_teto", language = "en", type = "song", name = "BIRDBRAIN", artist = "Jamie Paige", link = "https://www.youtube.com/watch?v=0iVlSNpq8i8" },
    { joker = "j_nic_tenebre_rosso_sangue_teto", language = "en", type = "song", name = "Tenebre Rosso Sangue [Cover]", artist = "Sandwich", link = "https://www.youtube.com/watch?v=ZZowC8QXshQ" },
    { joker = "j_nic_spoken_for_teto", language = "en", type = "song", name = "Spoken For", artist = "FLAVOR FOLEY", link = "https://www.youtube.com/watch?v=LvYL8u4p-aM" },
    { joker = "j_nic_teto_word_of_the_day", language = "en", type = "inspired", name = "Love and Stuff <3", link = "https://packaged-media.redd.it/a4bqjhn3dx6f1/pb/m2-res_480p.mp4?m=DASHPlaylist.mpd&c=wh_ben_en&var=sgpssan&v=1&e=1777672800&s=ab936fdd4882dca83bc69ac96e213ecf2bdec0ce" },
    { joker = "j_nic_mesmerizer_teto", language = "jp", type = "song", name = "メズマライザー", artist = "32ki", link = "https://www.youtube.com/watch?v=19y8YTbvri8" },
    ...
    { joker = "j_nic_minimum_rage_teto", language = "en", type = "song", name = "MINIMUM RAGE", artist = "MonochroMenace", link = "https://www.youtube.com/watch?v=J8vjHOyVxUA" },
    { joker = "j_nic_teto_territory", language = "jp", type = "song", name = "oxi", artist = "重音territory", link = "https://www.youtube.com/watch?v=JALbemLw3G4"  },
    { joker = "j_nic_contradictions_teto", language = "en", type = "song", name = "CONTRADICTIONS", artist = "Darkbluecat", link = "https://www.youtube.com/watch?v=A0ih5EaG4yw" },
    { joker = "j_nic_pear_basket", language = "en", type = "inspired", name = "The Pears Greed >:3", link = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOjN5WPuEoSRMRFaV9vCrpjYYjB6OQyXtMZg&s" },
    { joker = "j_nic_keychain_teto", language = "en", type = "inspired", name = "Portable Teto", link = "https://www.ebay.com/itm/167205736613" },
    { joker = "j_nic_log_off_teto", language = "en", type = "song", name = "LOG OFF", artist = "Staircatte", link = "https://www.youtube.com/watch?v=qKOJ5_IkUXY" },
    ...
    { joker = "j_nic_cadmium_colors", language = "en", type = "song", name = "Cadmium Colors", artist = "Jamie Paige", link = "https://www.youtube.com/watch?v=1U6qefKcOrg" },
    { joker = "j_nic_hito_mania", language = "jp", type = "song", name = "人マニア", artist = "原口沙輔", link = "https://www.youtube.com/watch?v=HTxwOxFt5d4" },
    { joker = "j_nic_rot_for_clout", language = "en", type = "song", name = "Rot For Clout", artist = "Jamie Paige", link = "https://www.youtube.com/watch?v=_AjJZEcMdww" },
    { joker = "j_nic_bread", language = "en", type = "inspired", name = "Bread :droul:", link = "https://share.google/bkYka8NHbI9vZpJGr" },
    { joker = "j_nic_machine_love", language = "en", type = "song", name = "Machine Love", artist = "Jamie Paige", link = "https://www.youtube.com/watch?v=sqK-jh4TDXo" },
}
